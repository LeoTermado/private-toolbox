...
TOOLS = [
    ...
    {"endpoint": "photo_exif_scrubber.index", "path": "/image/exif-scrubber/", "label": "Photo EXIF Scrubber", "icon": "🧼", "implemented": True},
    {"endpoint": "structured_data_beautifier.index", "path": "/data/beautifier/", "label": "Structured Data Beautifier", "icon": "✨", "implemented": True},
